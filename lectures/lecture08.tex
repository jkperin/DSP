...
\begin{enumerate}
	\only<1|handout:1>{
		...
		\begin{center}
			\resizebox{0.9\textwidth}{!}{\input{figs/twos_complement_overflow.tex}}
		\end{center}
	} \only<2|handout:2>{
		\setcounter{enumi}{1}
...
\begin{column}{0.5\textwidth}
	\begin{center}
		\resizebox{\textwidth}{!}{\input{figs/irr_coeff_quantiz_pole_zero.tex}}
	\end{center}
\end{column}

\begin{column}{0.6\textwidth}
	\begin{center}
		\resizebox{\textwidth}{!}{\input{figs/irr_coeff_quantiz_mag_resp.tex}}
	\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Roundoff noise in FIR systems}
	...
	\begin{center}
		\resizebox{0.75\textwidth}{!}{\input{figs/FIR_direct_form_I.tex}}
	\end{center}
	\vspace{-0.4cm}
...
\begin{frame}{1. Quantization immediately after multiplication}
	\begin{center}
		\def\Quantiz{1}
		\resizebox{\textwidth}{!}{\input{figs/FIR_direct_form_I_quantiz.tex}}
	\end{center}
...
\begin{frame}{2. Quantization immediately after accumulation}
	\begin{center}
		\def\Quantiz{1}
		\resizebox{\textwidth}{!}{\input{figs/FIR_direct_form_I_quantiz_end.tex}}
	\end{center}
	Equivalent \textbf{linear noise model}:
...
\begin{frame}{Direct form I IIR filter}
	...
	\begin{center}
		\def\QUANTIZ{1}
		\resizebox{\textwidth}{!}{\input{figs/IIR_direct_form_I_quantiz.tex}}
	\end{center}
\end{frame}
...
\begin{center}
	\resizebox{0.7\textwidth}{!}{\input{figs/IIR_direct_form_II_quantiz.tex}}
\end{center}
...
\begin{frame}{What about transposed forms?}
	\begin{columns}[t]
		\begin{column}{0.5\textwidth}
			...
			\begin{center}
				\resizebox{1.2\textwidth}{!}{\input{figs/IIR_transposed_direct_form_I_quantiz.tex}}
			\end{center}
		...
		\begin{column}{0.5\textwidth}
			...
			\vspace{-0.07cm}
			\begin{center}
				\resizebox{\textwidth}{!}{\input{figs/IIR_transposed_direct_form_II_quantiz.tex}}
			\end{center}
			Average power of each noise source
			\onslide<3|handout:0> {
				\begin{align*}
