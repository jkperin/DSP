...
\begin{frame}{Sampling the discrete-time Fourier transform (DTFT)}
	...
	\begin{center}
		\resizebox{0.65\textwidth}{!}{\input{figs/sampled_dtft.tex}}
	\end{center}
	\vspace{-0.25cm}	
...
\begin{center}
	\resizebox{\textwidth}{!}{\input{figs/impulse_train_dtft.tex}}
\end{center}
...
\begin{center}
	\def\N{3}
	\def\Ns{8}
	\resizebox{\linewidth}{!}{\input{figs/sampling_dtft.tex}}
\end{center}
\end{frame}
...
\begin{center}
	\def\N{10}
	\def\Ns{20}
	\hspace*{-0.6cm}\resizebox{0.96\paperwidth}{!}{\input{figs/sinc_dft.tex}}
\end{center}
...
\begin{center}
	\hspace*{-0.6cm}\resizebox{0.96\paperwidth}{!}{\input{figs/cosine_dft.tex}}
\end{center}
...
\begin{figure}
\centering
\resizebox{0.5\linewidth}{!}{\input{figs/sampled_unit_circle.tex}}
...
\begin{center}
	\resizebox{\textwidth}{!}{\input{figs/circular_time_shift.tex}}
\end{center}
\end{frame}
...
\begin{frame}{Understanding circular convolution}
	\begin{center}
		\resizebox{0.65\textwidth}{!}{\input{figs/circular_convolution.tex}}
	\end{center}
\end{frame}
...
\begin{frame}{Linear convolution using circular convolution}
	...
	\begin{center}
		\resizebox{0.8\textwidth}{!}{\input{figs/fir_filter_fft.tex}}
	\end{center}
...
\begin{frame}{Overlap and add}
\begin{center}
	\resizebox{0.85\textwidth}{!}{\input{figs/overlap_and_add.tex}}
\end{center}	
\end{frame}
...
\begin{frame}{Overlap and save}
\begin{center}
	\resizebox{0.85\textwidth}{!}{\input{figs/overlap_and_save.tex}}
\end{center}	
\end{frame}
