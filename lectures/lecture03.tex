...
\begin{center}
	\resizebox{0.8\linewidth}{!}{\input{figs/LTI_system_random_input.tex}}
\end{center}
...
\vspace{-0.4cm}
\begin{center}
	\resizebox{0.85\linewidth}{!}{\input{figs/sampling_example_freq_domain.tex}}
\end{center}
\vspace{-0.4cm}
...
\begin{center}
	\resizebox{0.7\linewidth}{!}{\input{figs/aliased_sinusoid.tex}}
\end{center}
\end{frame}
...
\begin{center}
	\resizebox{0.9\linewidth}{!}{\input{figs/aliased_sinusoid_freq.tex}}
\end{center}
...
\begin{center}
	\resizebox{0.9\linewidth}{!}{\input{figs/reconstruction_example_time.tex}}
\end{center}
\end{frame}
...
\end{columns}
\begin{center}
	\resizebox{\linewidth}{!}{\input{figs/ideal_lowpass_filter_ct.tex}}
\end{center}
\end{frame}
...
\begin{frame}{Practical reconstruction: zero-order holder (ZOH)}
	...
	\end{columns}
	\begin{center}
	\resizebox{\linewidth}{!}{\input{figs/zoh_time_freq.tex}}
\end{center}
\end{frame}
...
\begin{frame}{Practical reconstruction: cubic-spline interpolation}
	...
	\end{columns}
	\begin{center}
		\resizebox{\linewidth}{!}{\input{figs/spline_interp_time_freq.tex}}
	\end{center}
...
\vspace{-0.4cm}
\begin{center}
	\resizebox{0.85\linewidth}{!}{\input{figs/dt_processing_of_ct_signals.tex}}
\end{center}
\end{frame}
