...
\node[block] (s1) {\resizebox{0.1\linewidth}{!}{\input{figs/random_sequence.tex}}};
\node[left=0cm of s1,scale=0.15] {$X(n, \chi_1)$};

\node[block, below of=s1] (s2) {\resizebox{0.1\linewidth}{!}{\input{figs/random_sequence.tex}}};
\node[left=0cm of s2,scale=0.15] {$X(n, \chi_2)$};


\node[block, below of=s2] (s3) {\resizebox{0.1\linewidth}{!}{\input{figs/random_sequence.tex}}};
