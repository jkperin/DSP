...
\begin{frame}{Magnitude and phase response}
	...
	\begin{center}
		\begin{tikzpicture}
		\node (img1) {\resizebox{0.55\linewidth}{!}{\includegraphics{figs/first_order_sys_freqz.eps}}};
...
\begin{frame}{Phase unwrapping}
	...
	\begin{center}
		\resizebox{\textwidth}{!}{\input{figs/phase_unwrapping.tex}}
	\end{center}	
...
\begin{frame}{Effect of group delay}
	\begin{block}{Phase}
		\begin{center}
			\resizebox{0.7\linewidth}{!}{\includegraphics{figs/group_delay_example_phase.png}}
		\end{center}		
	\end{block}
\end{frame}
...
\begin{frame}{Effect of group delay}
	\begin{block}{Group delay and magnitude}
		\begin{center}
			\resizebox{0.7\linewidth}{!}{\includegraphics{figs/group_delay_example_delay_magnitude.png}}
		\end{center}		
	\end{block}
\end{frame}
...
\begin{frame}{Effect of group delay}
	...
	\begin{center}
		\begin{tikzpicture}
		\node (img1) {\resizebox{0.7\linewidth}{!}{\includegraphics{figs/group_delay_example_input.png}}};
...
\begin{frame}{Effect of group delay}
	\begin{block}{Output}
		...
		\begin{center}
			\begin{tikzpicture}
			\node (img1) {\resizebox{0.57\linewidth}{!}{\includegraphics{figs/group_delay_example_delay_magnitude.png}}};
			\node[below=0cm of img1] (img2) {\resizebox{0.55\linewidth}{!}{\includegraphics{figs/group_delay_example_output.png}}};
...
\begin{frame}{Poles, zeros, and the frequency response}
	...
	\begin{center}
		\resizebox{\linewidth}{!}{\input{figs/pole_zero_freq_resp_animation.tex}}
	\end{center}	
\end{frame}
...
\begin{frame}{Poles, zeros, and the frequency response}
	Example: $H(z) = 1 - 0.9e^{j\pi/4}z^{-1}$
	\begin{center}
		\resizebox{\linewidth}{!}{\input{figs/pole_zero_freq_resp_animation_phase.tex}}
	\end{center}	
\end{frame}
...
\begin{frame}{Poles, zeros, and the frequency response}
	...
	\begin{center}
		\resizebox{\linewidth}{!}{\input{figs/pole_zero_freq_resp_animation_pole.tex}}
	\end{center}	
\end{frame}
...
\begin{frame}{Poles, zeros, and the frequency response}
	Example: $H(z) = \displaystyle\frac{1}{1 - 0.9e^{j\pi/4}z^{-1}}$
	\begin{center}
		\resizebox{\linewidth}{!}{\input{figs/pole_zero_freq_resp_animation_pole_phase.tex}}
	\end{center}	
\end{frame}
...
\begin{frame}{Sketch the magnitude and phase responses}
	\hspace*{-1cm}\resizebox{0.95\paperwidth}{!}{\input{figs/sketch_pole_zero_freq_resp.tex}}
\end{frame}
...
\hspace*{-0.85cm}\resizebox{0.95\paperwidth}{!}{\input{figs/example_min_phase_allpass_decomp.tex}}
\begin{itemize}
...
\begin{center}
	\resizebox{0.7\linewidth}{!}{\input{figs/non-integer_delay.tex}}
\end{center}
\end{frame}
...
\begin{center}
	\resizebox{\linewidth}{!}{\input{figs/fir_typeIII-IV.tex}}
\end{center}
