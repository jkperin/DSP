...
\begin{center}
	\resizebox{\textwidth}{!}{\input{figs/dft_analog_signals.tex}}
\end{center}
...
\begin{center}
	\resizebox{0.7\textwidth}{!}{\input{figs/kaiser_spectrum_fixed_beta.tex}}
\end{center}
...
\begin{columns}
	\begin{column}{0.5\textwidth}
		\begin{center}
			\def\BETA{1}
			\resizebox{\textwidth}{!}{\input{figs/sinusoid_windowing_kaiser.tex}}
		\end{center}
	\end{column}
	\begin{column}{0.5\textwidth}
		\begin{center}
...
\begin{center}
	\resizebox{0.9\textwidth}{!}{\input{figs/speech_spectrogram_demo.tex}}
\end{center}
\end{frame}
