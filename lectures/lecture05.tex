...
\begin{frame}{Quantizer}
	\begin{columns}[t]
		...
		\begin{column}{0.5\textwidth}
			...
			\resizebox{\textwidth}{!}{\input{figs/midrise_quantizer.tex}}
		\end{column}
	\end{columns}
	\begin{center}
...
\begin{center}
	\resizebox{0.6\textwidth}{!}{\input{figs/quantization_sine.tex}}
\end{center}
...
\begin{frame}{Quantization of a sinusoid}
	...
	\begin{center}
		\resizebox{0.75\textwidth}{!}{\input{figs/quantization_sine_full.tex}}
	\end{center}
\end{frame}
...
\begin{center}
	\def\ALL{1}
	\resizebox{0.8\textwidth}{!}{\input{figs/noise_shaping_adc_diagram.tex}}
\end{center}
\end{frame}
...
\begin{center}
	\resizebox{0.8\textwidth}{!}{\input{figs/noise_shaping_adc_freq_domain.tex}}
\end{center}
